    ...
    <div id="general-section" class="container my-5">
        ...
        <div class="row">
            <div class="col-sm d-flex align-items-center">
                <div>
                    <p class="text-center" style="font-size: 1.5em;"><strong>{{ $heading1 }}</strong></p>
                    <p>
                        {{ $content1 }}
                    </p>
            ...
            <div class="col-sm">
                <img src="/images/{{ $image1 }}" alt="dancers" class="img-fluid shadow rounded">
            </div>
        </div>

        <div class="row my-4">
            <div class="col-sm">
                <img src="/images/{{ $image2 }}" alt="" class="img-fluid shadow rounded">
            </div>
            <div class="col-sm d-flex align-items-center">
                <div>
                    <p class="text-center" style="font-size: 1.5em;"><strong>{{ $heading2 }}</strong></p>
                    <p>
                        {{ $content2 }}
                    </p>
                    <div class="d-flex justify-content-center">
        ...
        <div class="row">
            <div class="col-sm d-flex align-items-center">
                <div>
                    <p class="text-center" style="font-size: 1.5em;"><strong>{{ $heading3 }}</strong></p>
                    <p>
                        {{ $content3 }}
                    </p>
                    <div class="d-flex justify-content-center">
            ...
            <div class="col-sm">
                <img src="/images/{{ $image3 }}" alt="dancers" class="img-fluid shadow rounded">
            </div>
        </div>
