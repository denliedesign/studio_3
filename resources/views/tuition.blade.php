...
{{--                <div class="shadow rounded p-5">--}}
{{--                    <p>--}}
{{--                        <span class="stand-out">NEW Premium Classes</span>--}}
{{--                        <br>We will be offering PREMIUM CLASSES for 3-4 dancers in Ballet, Tap, Jazz, Acro and Technique. These classes will be offered as requested.  This is for dancers wanting smaller class sizes or a class to meet their busy schedule. Call the office to find out details for those interested.--}}
{{--                    </p>--}}
{{--                    <table class="table">--}}
{{--                        <tr>--}}
{{--                            <td>30 minute</td>--}}
{{--                            <td>$90 monthly</td>--}}
{{--                            <td>$8.75 more per class</td>--}}
{{--                        </tr>--}}
{{--                        <tr>--}}
{{--                            <td>45 minute</td>--}}
{{--                            <td>$125 monthly</td>--}}
{{--                            <td>$12 more per class</td>--}}
{{--                        </tr>--}}
{{--                        <tr>--}}
{{--                            <td>55 minute</td>--}}
{{--                            <td>$145 monthly</td>--}}
{{--                            <td>$14.25 more per class</td>--}}
{{--                        </tr>--}}
{{--                    </table>--}}
{{--                </div>--}}
{{--            <div class="col-sm">--}}
