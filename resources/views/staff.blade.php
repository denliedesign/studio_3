<x-app-layout>
    ...
    <div id="staff" class="container mt-5">
        <h1>Studio <span style="color: #e11b22;">3</span> Staff</h1>
        <div class="teacher-single mb-5">
            <div class="row">
                <div class="col-sm-3 d-flex justify-content-center">
                    <img src="/images/staff-brenda.jpg" alt="dance teacher" class="img-fluid shadow">
                </div>
        ...
        <div class="teacher-single my-5">
            <div class="row">
                <div class="col-sm-3 d-flex justify-content-center">
                    <img src="/images/staff-allison.jpg" alt="dance teacher" class="img-fluid shadow">
                </div>
                <div class="col-sm-9 d-flex align-items-center">
                    <p class="mx-5 p-3">
                        <span class="fw-bold staff-name" style="font-size: 1.25em;">Allison Clark</span><br>
        ...
        <div class="teacher-single my-5">
            <div class="row">
                <div class="col-sm-3 d-flex justify-content-center">
                    <img src="/images/beck.png" alt="dance teacher" class="img-fluid shadow">
                </div>
                <div class="col-sm-9 d-flex align-items-center">
                    <p class="mx-5 p-3">
                        <span class="fw-bold staff-name" style="font-size: 1.25em;">Becky Beck</span><br>
        ...
        <div class="teacher-single my-5">
            <div class="row">
                <div class="col-sm-3 d-flex justify-content-center">
                    <img src="/images/staff-sally.jpg" alt="dance teacher" class="img-fluid shadow">
                </div>
                <div class="col-sm-9 d-flex align-items-center">
                    <p class="mx-5 p-3">
                        <span class="fw-bold staff-name" style="font-size: 1.25em;">Sally Johnson</span><br>
        ...
        <div class="teacher-single my-5">
            <div class="row">
                <div class="col-sm-3 d-flex justify-content-center">
                    <img src="/images/staff-katherine.jpg" alt="dance teacher" class="img-fluid shadow">
                </div>
                <div class="col-sm-9 d-flex align-items-center">
                    <p class="mx-5 p-3">
        ...
        <div class="teacher-single my-5">
            <div class="row">
                <div class="col-sm-3 d-flex justify-content-center">
                    <img src="/images/adriana.jpg" alt="dance teacher" class="img-fluid shadow">
                </div>
                <div class="col-sm-9 d-flex align-items-center">
                    <p class="mx-5 p-3">
        ...
        <div class="teacher-single my-5">
            <div class="row">
                <div class="col-sm-3 d-flex justify-content-center">
                    <img src="/images/ashleigh.jpg" alt="dance teacher" class="img-fluid shadow">
                </div>
                <div class="col-sm-9 d-flex align-items-center">
                    <p class="mx-5 p-3">
        ...
        <div class="my-5 py-5" style="font-size: 0.9em;">
            <p class="text-center">
                Studio 3 is always looking for positive, enthusiastic and qualified instructors.
                <br>We are currently looking for a part-time office assistant/receptionist.
                <br>If you <span class="fw-bold" style="color: #e11b22;">LOVE</span> dance and working with children, please send your resume to Brenda Wilder at studiothree.dance @gmail.com
            </p>
        </div>
    </div>
