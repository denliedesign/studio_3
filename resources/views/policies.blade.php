<x-app-layout>
    ...
    <div id="general-section" class="my-5 container">
        ...
        <div class="d-flex justify-content-center">
            <a href="/images/policies-8-23-22.pdf" target="_blank">
                <button class="btn btn-lg btn-danger shadow mb-4">View Policies PDF For 2022-2023</button>
            </a>
        </div>
        <div class="row m-0 p-0">
            <div class="col-sm rotated-bg-blue rounded my-5">
                <img src="/images/policies-8-23-22.jpg" alt="studio policies" class="p-5 rerotate img-fluid">
            </div>
