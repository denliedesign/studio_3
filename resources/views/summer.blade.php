<x-app-layout>
    ...
    <div id="general-section" class="container">
        <h1 class="mt-5">2021 S3D Summer Camps, Intensive & Workshops</h1>
        <div class="my-5">
        ...
        <div>
            <div class="row m-0 p-0">
                ...
                <div class="col-sm">
                    <img src="/images/summer-snow-queen.jpg" alt="summer sign up" class="img-fluid shadow rounded mb-4">
                    <div class="d-flex justify-content-center">
                        <a href="https://app.thestudiodirector.com/studio3dance/portal.sd?page=Login" target="_blank">
                            <button class="btn btn-lg btn-danger shadow mb-4">Register Now</button>
                        </a>
            ...
            <div class="row mt-4">
                <div class="col-sm">
                    <img src="/images/summer-sessions-1.jpg" alt="summer sessions 1"
                         class="img-fluid shadow rounded mb-4">
                </div>
                <div class="col-sm">
                    <img src="/images/summer-sessions-2.jpg" alt="summer sessions 2"
                         class="img-fluid shadow rounded mb-4">
                </div>
            </div>
            <div class="d-flex justify-content-center">
