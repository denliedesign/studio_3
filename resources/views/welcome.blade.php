                ...
                <div class="row">
                    <div class="col-sm">
                        <div class="shadow p-5 mx-sm-3 my-3 rounded bg-white" style="max-width: 500px;">
                            <span class="stand-out">Studio 3 Dance offers a diverse schedule of dance classes in Plano for children ages 18 months and up.</span>
            ...
            <div class="d-flex align-items-center justify-content-center py-4">
                ...
                <div class="col-sm">
                    <div class="d-flex justify-content-center align-items-center">
                        <img src="/images/newsletter-dancers.jpg" class="img-fluid rounded shadow" alt="" style="max-height: 500px; width: auto;">
                    </div>
                </div>
                <div class="col-sm">
                    ...
                    <div id="mc_embed_signup" class="rounded">
                        <form action="https://studio3dance.us5.list-manage.com/subscribe/post?u=054c54a0b945b0441370b4586&amp;id=be609cca46&amp;f_id=0056ffe6f0" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" class="validate" target="_blank" novalidate>
                            <div id="mc_embed_signup_scroll">
                                <h2>Subscribe to our Studio 3 Dance Newsletter</h2>
                                ...
                                <div class="mc-field-group">
                                    <label for="mce-MMERGE3">Your Dancer/s first name/s </label>
                                ...
                                <div style="position: absolute; left: -5000px;" aria-hidden="true"><input type="text" name="b_054c54a0b945b0441370b4586_be609cca46" tabindex="-1" value=""></div>
