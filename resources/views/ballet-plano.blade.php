...
@section('content')
    ...
    <div id="general-section" class="container my-5">
        <div class="row">
            ...
            <div class="col-sm">
                <img src="/images/ballet-plano.jpg" alt="ballerinas" class="img-fluid shadow rounded">
            </div>
        </div>

        <div class="row my-4">
            <div class="col-sm">
                <img src="/images/plano-ballet.jpg" alt="ballerinas" class="img-fluid shadow rounded">
            </div>
            <div class="col-sm d-flex align-items-center">
                <div>
        ...
        <div class="row">
            ...
            <div class="col-sm">
                <img src="/images/ballet-in-plano-tx.jpg" alt="ballerinas" class="img-fluid shadow rounded">
            </div>
        </div>
