...
@section('content')
    ...
    <div id="general-section" class="container my-5">
        <h1 class="my-4">Welcome to Studio 3 Dance</h1>
        <div class="row">
            ...
            <div class="col-sm">
                <img src="/images/dance-classes-in-plano.jpg" alt="children practicing their balance in class" class="img-fluid shadow rounded">
            </div>
        </div>

        <div class="row my-4">
            <div class="col-sm">
                <img src="/images/dance-classes-in-plano-tx.jpg" alt="view of recital stage from behind the curtain" class="img-fluid shadow rounded">
            </div>
            <div class="col-sm d-flex align-items-center">
                <div>
